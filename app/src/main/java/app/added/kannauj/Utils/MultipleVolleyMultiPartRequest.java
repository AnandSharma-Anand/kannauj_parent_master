...
public class MultipleVolleyMultiPartRequest extends Request<NetworkResponse> {
    ...
    public MultipleVolleyMultiPartRequest(String url, Map<String, String> headers,
    ...
    public MultipleVolleyMultiPartRequest(int method, String url,
                                          Response.Listener<NetworkResponse> listener,
                                          Response.ErrorListener errorListener) {
